...
|---------|------|-----------------|
| `className` | `string` | — |
| `content` | `object` | `content.settings.decoration.bodyFont`, `content.settings.decoration.bodyFont.item`, `content.settings.decoration.bodyFont.item.body`, `content.settings.decoration.headingFont` |
| `lock` | `object` | — |
| `metadata` | `object` | — |
...
- `content.settings.decoration.headingFont`
