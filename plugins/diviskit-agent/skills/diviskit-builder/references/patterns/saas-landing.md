...
When `oa` presets are available, reference them instead of inline font styling. Resolve `<role-key>` placeholders from `.devin/skills/diviskit-builder/design-system.json`:
