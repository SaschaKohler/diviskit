<?php
/**
 * Trait Diviskit_Agent_Meta
 *
 * Plugin meta surface: handshake, settings, theme options, icons, cache flush.
 *
 * Part of the diviskit-agent monolith split (#220). Mixed into
 * Diviskit_Agent via `use` in diviskit-agent.php — `self::` calls and
