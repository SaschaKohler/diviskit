...
trait Diviskit_Agent_Core {
	...
	private static function empty_object_paths_key(): string {
		return '__diviskit_empty_object_paths';
	}
	...
	private static function read_divi_global_variables_registry(): array {
		// Divi-owned integration state; do not rename to a Diviskit option.
	...
	// ── Envelope helpers ─────────────────────────────────────────────
	//
	// Standard response shape for every diviskit-agent route:
	 ...
	 *
	 * @param string      $code         Machine-readable code from the diviskit vocabulary
	 ...
	 *                                  diviskit-server/src/envelope.ts and
